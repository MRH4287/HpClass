...
$userdatei = fopen ("../include/config.php","w");
     ...
     // $userdatei = fopen ($datakata,"a");
      ...
      fwrite($userdatei, "\n");
      fwrite($userdatei, "//Design\n");
      fwrite($userdatei, "\$design=\"default\";\n");
      fwrite($userdatei, "\n");
      fwrite($userdatei, "// Websiten Titel\n");
      fwrite($userdatei, "\$titel=\"Webseiten Titel\";\n");
      fwrite($userdatei, "\n");
      fwrite($userdatei, "// Hauptüberschrifft\n");
      fwrite($userdatei, "\$mainheadline=\"<font size=\\\"2\\\" face=\\\"Comic Sans MS\\\">Beispieltext</font>\";");
      fwrite($userdatei, "\n");
      fwrite($userdatei, "//Unterüberschrifft\n");
      fwrite($userdatei, "\$headline=\"\";\n");
      fwrite($userdatei, "\n"); 
      fwrite($userdatei, "?"); 
      fwrite($userdatei, ">\n");
      fclose($userdatei);
